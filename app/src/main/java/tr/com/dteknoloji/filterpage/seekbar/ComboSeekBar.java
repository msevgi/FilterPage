...
package tr.com.dteknoloji.filterpage.seekbar;
...
import tr.com.dteknoloji.filterpage.R;
...
public class ComboSeekBar extends SeekBar {
   ...
   public ComboSeekBar(Context context, AttributeSet attrs) {
      ...
      mColor = a.getColor(R.styleable.ComboSeekBar_color1, Color.WHITE);
   ...
   public void setColor(int color) {
      ...
      setProgressDrawable(new CustomDrawable((CustomDrawable) this.getProgressDrawable(),
                                             this,
                                             mThumb.getRadius(),
                                             mDots,
                                             color,
